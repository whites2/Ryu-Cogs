...
class Hearthstone:
    ...
    async def card(self, *name):
        ...
        r = requests.get('https://omgvamp-hearthstone-v1.p.mashape.com/cards/{}?collectible=1'.format(' '.join(name)), headers={'X-Mashape-Key':'sly1A6Ur3tmshrDtRbWe4q738Afxp1cnkhajsnWqVf9HMJ7ZOJ'}) 
